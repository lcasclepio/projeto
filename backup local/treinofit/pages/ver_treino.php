    ...
    <body>
        <div class="no-treino-box">
            <div class="empty-state" style="padding:32px;">
                <p class="no-treino-msg">Este aluno ainda não possui treino.</p>
...
<body>
    <div class="treino-container">
        <div class="treino-header">
            ...
            <p>Visualize o treino do aluno</p>
        </div>
                    ...
                    <div class="treino-card">
                        <div class="treino-card-header">
                            ...
                            <div class="treino-card-actions">
                                <a href="alterar/treino.php?id=<?= $treino['id'] ?>" class="btn-edit" title="Editar">✏️</a>
                                <a href="#" onclick="apagarTreino(<?= $treino['id'] ?>, event)" class="btn-delete" title="Apagar">🗑️</a>
                            </div>
                        </div>
    ...
    <script>
        function apagarTreino(id, event) {
            ...
            fetch('excluir/treino.php?id=' + id)
                ...
                .catch(error => {
                    mostrarToast('Erro ao apagar treino', 'erro');
                });
        }
